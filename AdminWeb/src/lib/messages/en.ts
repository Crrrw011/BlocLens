export const en = {
  ...
  configuration: {
    ...
    groups: {
      ...
      frozen: "Frozen product rules",
    },
    fields: {
      queueOrder: "Default queue order",
      orders: {
        newest_first: "Newest first",
        oldest_first: "Oldest first",
        severity_first: "Severe first",
      },
      defaultRange: "Default time range",
      moderationNotes: "Moderation notes",
      templates: "Templates (one per line)",
    },
    frozen: [
      "Grade aggregates are computed by the server and never edited directly.",
      "Helpful counts are computed by the server and never edited directly.",
      "Trust thresholds are fixed product rules.",
      "Private Logbook content is never exposed or exported.",
      "Audit history older than 90 days keeps digests, never raw IPs.",
    ],
    reasonLabel: "Reason",
    reasonPlaceholder: "Why is this change needed? Kept in the audit record.",
    save: "Save changes",
